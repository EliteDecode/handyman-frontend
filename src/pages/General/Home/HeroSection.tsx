...
const HeroSection = () => {
  return (
    <div className="flex flex-col items-center sm:gap-0 gap-6 px-6 md:flex-row lg:px-[120px] md:px-10 w-full max-w-[1440px]">
      {/* Left Content */}
      <div className="flex flex-col items-center w-full gap-6 text-center md:items-start md:text-start">
        ...
        <button className="max-w-[208px] w-full h-14 px-4 bg-[#008080] text-white text-[18px] leading-[24px] font-semibold rounded-lg hover:bg-[#006666] transition-colors">
          Get Early Access
        </button>
      </div>
