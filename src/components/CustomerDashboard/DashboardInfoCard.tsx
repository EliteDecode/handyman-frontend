...
const DashboardInfoCard = () => {
  return (
    <div className="shadow-custom lg:p-6 p-4">
      ...
      <div className="lg:h-14 h-10 flex items-center gap-6 w-full lg:mt-6 mt-4">
        ...
        <button className="h-full p-4 flex items-center gap-2 bg-[#F5F5F5] rounded-md outline-none text-xs lg:text-base">
