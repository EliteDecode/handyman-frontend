        ...
        >
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-[12px] leading-6 tracking-2-percent text-[#3C3C3C]">
                This service will be added to your profile
              </p>
            </div>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-[12px] leading-6 tracking-2-percent text-[#3C3C3C]">
                This rate will be visible to clients for future bookings
              </p>
            </div>
            ...
            <div className="flex flex-col gap-1 font-lato">
              ...
              <input
                name="rate"
                id="rate"
                value={Number(formik.values.rate).toLocaleString()} // format for display only
                onChange={(e) => {
